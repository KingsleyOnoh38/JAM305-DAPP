...
import heroImg from "../public/img/305LOGO.jpg";

const Hero = () => {
  return (
    <Container className="flex flex-wrap">
      <div className="flex items-center w-full lg:w-1/2">
        <div className="max-w-2xl mb-8 ml-6">
      ...
      <div className="rounded-3xl border-dotted flex items-center justify-center w-full lg:w-1/2">
